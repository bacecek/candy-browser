...
internal object TextInputOcclusionScript {
    fun javascript(viewportRect: BrowserViewportRect): String = """
        (() => {
          const obstruction = {
            left: ${viewportRect.leftFraction},
            top: ${viewportRect.topFraction},
            right: ${viewportRect.rightFraction},
            bottom: ${viewportRect.bottomFraction},
          };
          ...
          const blocked = {
            ...
            right: viewportLeft + obstruction.right * viewportWidth,
            bottom: viewportTop + obstruction.bottom * viewportHeight,
          };
